...
import { Lock, Mail, UserPlus, KeyRound, AlertCircle, Sparkles, Eye, EyeOff } from "lucide-react";
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full bg-slate-50 border border-slate-200 rounded-lg pl-9 pr-10 py-2 text-sm text-slate-800 focus:border-blue-500 focus:bg-white outline-none transition-all duration-200"
                  />
                  <button
                    type="button"
